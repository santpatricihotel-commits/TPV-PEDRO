...
const productos = [
  { id: 1, nombre: 'SEMI 1/8', precio: 8.00, color: 'bg-yellow-500' },
  { id: 2, nombre: 'CURAT 1/8', precio: 9.00, color: 'bg-amber-500' },
  { id: 3, nombre: 'AÑEJO 1/8', precio: 6.00, color: 'bg-orange-500' },
  { id: 4, nombre: 'ES MOLL', precio: 16.00, color: 'bg-rose-500' },
  { id: 5, nombre: 'SA VERMELLA', precio: 19.00, color: 'bg-red-400' },
  { id: 6, nombre: 'ES MOLL + AÑEJO', precio: 19.00, color: 'bg-blue-400' },
  { id: 7, nombre: 'SA VERMELLA + AÑEJO', precio: 22.00, color: 'bg-blue-600' },
